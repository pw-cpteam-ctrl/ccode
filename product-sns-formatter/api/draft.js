...
function buildPrompt(productText, extraInstruction, brand) {
  return [
    ...
    '',
    '규칙:',
    '1. 시리즈명·캐릭터명 등 고유명사는 한국 팬덤/공식 매체에서 통용되는 한국어 표기로 바꿔라',
    '   (예: "Blue Archive" → "블루아카이브", "Fate/Grand Order" → "페이트 그랜드 오더").',
    '   통용되는 한국어 표기를 확신할 수 없으면 원문 그대로 두거나 발음 그대로 옮겨 적어라 — 지어내지 마라.',
