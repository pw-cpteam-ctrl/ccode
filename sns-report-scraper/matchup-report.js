...
※ 🗨️ 인용은 X 상세 페이지의 통계 줄에서 읽습니다 — 인용이 하나도 없으면 <b>0</b>, 아예 못 읽었으면 <b>'-'</b>로 나옵니다(0과 못 읽음을 구분합니다).<br>
※ 📷 스크린샷에는 게시물 미리보기(임베드)가 안 찍힙니다 — 다른 사이트에서 온 카드라 브라우저가 그림으로 옮겨주지 않습니다. 숫자와 본문은 정상적으로 찍힙니다.<br>
