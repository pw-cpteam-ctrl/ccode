...
check('html-report: SNS 표 우측 매출 매칭 컬럼 + 하단 재고 스냅샷 섹션, 둘 다 있어야 함', () => {
  ...
  const stockComparison = {
    ...
    snapshotCount: 2,
    stores: {
      PW: [{ productId: 'X1', name: '은혼 GEM 카무이 ver.2', price: 220000, stock: 9486, prevStock: 9999, stockDelta: 513 }],
  ...
  assert.ok(html.includes('🥇 (-513)'), '은혼 GEM 상품 행에 매칭된 판매 추정치가 표시돼야 함');
