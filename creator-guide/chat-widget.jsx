...
3. 광고 표기 — 본문 첫 부분 또는 이미지·영상 내 잘 보이는 위치에 '#광고' 또는 '#협찬' 표시
...
출처: 05 제작 규칙 탭`,
    ...
    {
      q: '보상은 언제, 어떻게 받나요?',
      a: `보상은 "얼마를 받는지"와 "언제 받는지" 두 가지로 나뉩니다.

[얼마를] 구매 링크를 통한 유입 수에 따라 정해집니다
· 유입 750 미만 — 5만 원 상당 (스토어 5만 원 쿠폰 또는 해당 월 룩업 단품)
· 유입 750 이상 — 10만 원 상당 (스토어 10만 원 쿠폰 또는 해당 월 룩업 세트)

[언제] 선지급과 후지급 중에서 직접 고르실 수 있습니다
· 선지급 — 업로드 확인 후 7일 이내 5만 원 상당, 프리오더 종료 후 최종 정산에서 유입 750 이상 확인 시 5만 원 상당 추가
· 후지급 — 프리오더 마감 이후 한 번에 지급

10만 원대 단품을 구매하실 계획이라면 후지급을 선택해 주세요. 쿠폰 두 장을 합쳐서 쓸 수는 없습니다. 한 번 정하시면 변경이 어려우니 신중히 골라주세요.
