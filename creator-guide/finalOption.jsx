...
const EVENT_GUIDE = {
  ...
  // 나머지 상세는 접어 둔다.
  musts: [
    { t: '이벤트 기간 7일 이상', d: '참여자가 모이려면 최소 일주일은 필요해요' },
  ...
  details: [
    ...
    // 어디서 나온 숫자인지까지 여기서 한 번에 매듭짓는다.
    {
      ...
      body: '경품 쿠폰이 나가는 날짜는 크리에이터님 보상과 같습니다. 다만 그 회차에 실리는 기준이 달라요 — 크리에이터님 보상은 업로드 확인, 경품 쿠폰은 당첨자 정보 전달입니다.',
      bullets: [
        '오픈 후 9일차까지 당첨자 정보를 주신 경우 — 오픈 후 10일차에 일괄 발급',
        '그 이후에 주신 경우 — 프리오더 정산 시점(오픈일 기준 약 40일)에 함께 발급',
      ],
      note: '10일차 발급에 맞추려면 그 전날까지 정보가 필요해서 9일차예요. 오픈일에 7일 이벤트를 시작하시면 발표·정리까지 여유 있게 들어옵니다. 더 길게 하셔도 되지만 프리오더 기간 안에는 마무리해 주세요',
    },
    {
      emoji: '💬',
    ...
    <div className="ev">
      ...
      <div className="ev-body">
        ...
        <div className="ev-free">
          <div className="ev-free-title">나머지는 자유롭게 정하셔도 돼요</div>
