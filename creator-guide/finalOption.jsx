...
const EVENT_GUIDE = {
  ...
  // 나머지 상세는 접어 둔다.
  musts: [
    { t: '이벤트 기간 7일 이상', d: '참여자가 모이려면 최소 일주일은 필요해요. 프리오더 기간(오픈 후 약 한 달) 안에는 마무리해 주세요' },
  ...
  details: [
    {
      ...
      note: '유입 수에 따른 보상은 이벤트를 진행하셔도 그대로 적용됩니다. 자세한 보상 종류는 06 보상 탭을 참고해 주세요.',
    },
    {
      emoji: '⏱',
      title: '경품 쿠폰은 언제 지급되나요',
      body: '콘텐츠 업로드가 확인되고 당첨자 정보를 받으면 발급됩니다.',
      bullets: [
        '오픈 후 9일 안에 당첨자 정보를 전달해 주신 경우 — 오픈 후 10일차에 일괄 발급',
        '이벤트를 더 길게 진행하시는 경우 — 프리오더 정산 시점(오픈일 기준 약 40일)에 함께 발급',
      ],
      note: '프리오더 기간 안에서는 길게 진행하셔도 됩니다. 경품이 나가는 시점만 달라집니다',
    },
    {
      emoji: '📋',
      ...
      <div className="ev-body">
        ...
        <details className="ev-more">
          <summary className="ev-more-head">
            <span>자세한 안내 보기</span>
            <span className="ev-more-sub">경품 형태 · 지급 시점 · 당첨자 정보 · 공유할 내용</span>
    ...
    <div className="section">
      ...
      <div className="rwd">
        ...
        <ul className="rwd-notes">
          ...
          <li>유입 수는 구매 링크를 통해 들어온 고객 수를 말합니다</li>
