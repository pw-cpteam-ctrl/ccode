...
const EVENT_GUIDE = {
  ...
  details: [
    {
      emoji: '🏷',
      title: '경품 형태는 두 가지입니다',
      body: '보상과 같은 두 종류 중에서 고르시면 됩니다.',
      bullets: [
    ...
    // 화면 곳곳에 7일·9일·10일·40일이 흩어져 있으면 "숫자가 왜 이렇게 많나"로
    // 읽힌다. 발급 날짜는 크리에이터 보상과 같다는 것을 먼저 말하고, 9일이
    // 어디서 나온 숫자인지까지 여기서 한 번에 매듭짓는다.
    {
      emoji: '⏱',
      title: '경품 쿠폰은 언제 지급되나요',
      body: '경품 쿠폰이 나가는 날짜는 크리에이터님 보상과 같습니다. 단, 회차에 반영되는 기준이 다릅니다 — 크리에이터님 보상은 업로드 확인, 경품 쿠폰은 당첨자 정보 전달입니다.',
      bullets: [
        '오픈 후 9일차까지 당첨자 정보를 주신 경우 — 오픈 후 10일차에 일괄 발급',
        '그 이후에 주신 경우 — 프리오더 정산 시점(오픈일 기준 약 40일)에 함께 발급',
      ],
      note: '10일차 발급 전날까지 정보가 필요해서 마감이 9일차입니다. 오픈일에 7일 이벤트를 시작하시면 발표·정리까지 기한 안에 들어옵니다. 더 길게 하셔도 되지만 프리오더 기간 안에는 마무리해 주세요',
    },
    {
      emoji: '💬',
      title: '진행 전 공유해 주실 내용',
      body: '아래 내용을 담당자에게 알려주시면 됩니다.',
      bullets: [
    ...
    <div className="ev">
      ...
      <div className="ev-body">
        ...
        <div className="ev-free">
          <div className="ev-free-title">나머지는 자유롭게 정하시면 됩니다</div>
